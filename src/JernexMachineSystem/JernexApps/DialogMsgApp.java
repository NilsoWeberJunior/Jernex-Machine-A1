...
public class DialogMsgApp {
    public static void CreateWarningMsg(JDesktopPane desktop, String msgTitle, String msg) {
    ...
    public static void CreateInfoMsg(JDesktopPane desktop, String msgTitle, String msg) {

        ImageIcon appIconFile = ImageManagement.SearchArchiveInThisJarAndTransformToIcon("JernexMachineSystem/assets/JernexInfoDialogMSGAppIcon.png", DialogMsgApp.class);
    ...
    public static void CreateErrorMsg(JDesktopPane desktop, String msgTitle, String msg) {

        ImageIcon appIconFile = ImageManagement.SearchArchiveInThisJarAndTransformToIcon("JernexMachineSystem/assets/JernexErrorDialogMSGAppIcon.png", DialogMsgApp.class);
